...
import VivekVihar1 from "../../assets/VivekVihar.jpg";
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4">
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${VivekVihar1})`,
      ...
      >
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-white text-center z-10">
